...
static const struct regval ov13855_global_regs[] = {
	...
	{0x5407, 0x01},
	{0x5408, 0x4a},
	{0x3503, 0x08},//关闭自动曝光增益，备份增益使能位设置为3
	{REG_NULL, 0x00},
};
...
static const struct regval ov13855_1920x1080_regs[] = {
	//配置参考 ov13855_4224x3136_30fps_regs[] 
	{0x0300, 0x02},
	{0x0301, 0x00},
	{0x0302, 0x5a},
	{0x0303, 0x00},
	...
	{0x3800, 0x04},  
	{0x3801, 0x90},  //x_start为0x0490
	{0x3802, 0x04}, 
	{0x3803, 0x14},  //y_start为0x0414
	{0x3804, 0x0c},  
	{0x3805, 0x0f},  //x_end为0x0c0f
	{0x3806, 0x08},  
	{0x3807, 0x4b},  //y_end为0x084b
	{0x3808, 0x07}, 
